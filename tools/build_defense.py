...
def main():
    ...
    notes += ['## Ответы на вопросы', '',
              ...
              '- LLM-агент Qwen3 локально на CPU выбирает инструменты, проверяет граф и ссылается на факты. Для демо нужна подготовленная модель; быстрый поиск отдельно помечен как режим без LLM.',
